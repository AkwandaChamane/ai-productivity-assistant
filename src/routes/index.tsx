    ...
    <div className="space-y-10">
      <section className="space-y-4">
        ...
        <div className="flex flex-wrap gap-3 pt-2">
          ...
          <Link
            to="/settings"
            className="rounded-md border border-input bg-background px-4 py-2 text-sm font-medium hover:bg-accent focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-baby-blue focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
            Settings & API key
          </Link>
        </div>
