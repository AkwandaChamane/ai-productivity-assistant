    ...
    <div className="space-y-6">
      ...
      <form onSubmit={submit} className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <button
          type="submit"
          disabled={loading}
          className="rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-baby-blue focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:opacity-50"
        >
